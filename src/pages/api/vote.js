...
export const POST = async ({ request }) => {
  try {
    ...
    // Roi et Reine sont optionnels : le vote blanc est autorisé pour ces deux champs,
    // c'est pourquoi ils ne figurent pas dans une liste de catégories "obligatoires".
